...
export const DATA_ERROR_CODES = [
  ...
  "DATA_SPACE_NOT_FOUND", "DATA_SPACE_ALREADY_EXISTS", "ENTITY_NOT_FOUND", "SCHEMA_INVALID", "SCHEMA_VERSION_CONFLICT",
  "SCHEMA_MIGRATION_REQUIRED", "RECORD_NOT_FOUND", "RECORD_VERSION_CONFLICT", "FIELD_UNKNOWN", "FIELD_INVALID",
  "REFERENCE_INVALID", "QUERY_INVALID", "QUERY_LIMIT_EXCEEDED", "PERMISSION_DENIED", "APPROVAL_REQUIRED",
