...
test("package metadata exposes package, CLI, protocol, storage, scope, catalog, and records subpaths", () => {
...
test("foundation surface reports record CRUD support without claiming query execution", () => {
  assert.equal(AI_VERSE_DATA_PACKAGE, "@ai-verse/data");
  assert.equal(AI_VERSE_DATA_FOUNDATION_PHASE, "1.6");
